...
router.post("/incidents", function (req, res) {
    ...
    var values = [incident.type, incident.event, incident.make, incident.model, incident.color, incident.plate, incident.driver, incidient.property, incident.direction, incident.phone, incident.insuranceInfo, incident.name];
    console.log(values);
